        ...
        <div class="container-fluid">
            <div class="navbar-header col-md-10 col-xs-10">
                <a class="navbar-brand" href="javascript:void(0);">
                    <img src="<cdn:url  value='/resources/global/images/municipality_logo.png'/>" height="60">
                    <div>
						<span class="title2">
						<c:set var="titleKey">
                ...
                <ul class="hr-menu text-right">
                    <li class="ico-menu">
                        <a href="http://www.zm4a.org" target="_blank">
                            <img src="<cdn:url  value='/resources/global/images/logo@2x.png'/>" title="An eGovZM Solution!" height="20px">
                        </a>
                    </li>
