...
public class MarriageRegistrationRequest {
    ...
    @NotNull(message = "Provide NRC number of bridegroom")
    @SafeHtml
    @Length(min=12,max=12,message="BrideGroom NRC Number should be 12 digit")
    ...
    @SafeHtml
    @Length(min=12,max=12,message="Bride NRC Number should be 12 digit")
