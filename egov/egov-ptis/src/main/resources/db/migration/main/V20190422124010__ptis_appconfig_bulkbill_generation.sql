...
INSERT INTO eg_appconfig_values ( ID, KEY_ID, EFFECTIVE_FROM, VALUE, VERSION ) VALUES (nextval('SEQ_EG_APPCONFIG_VALUES'), (SELECT id FROM EG_APPCONFIG WHERE KEY_SNAME='PTIS_BULKBILL_GENERATION_SCHEDULER_ENABLED'), current_date,'N',0);
